...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_openin = QtWidgets.QPushButton(self.tab_video)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_openin.sizePolicy().hasHeightForWidth())
        self.btn_openin.setSizePolicy(sizePolicy)
        self.btn_openin.setMinimumSize(QtCore.QSize(30, 0))
        self.btn_openin.setMaximumSize(QtCore.QSize(30, 16777215))
        self.btn_openin.setObjectName("btn_openin")
        self.inout_controls.addWidget(self.btn_openin)
        ...
        self.btn_chooseout = QtWidgets.QPushButton(self.tab_video)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_chooseout.sizePolicy().hasHeightForWidth())
        self.btn_chooseout.setSizePolicy(sizePolicy)
        self.btn_chooseout.setMinimumSize(QtCore.QSize(30, 0))
        self.btn_chooseout.setMaximumSize(QtCore.QSize(30, 16777215))
        self.btn_chooseout.setObjectName("btn_chooseout")
        self.inout_controls.addWidget(self.btn_chooseout)
        ...
        self.btn_run = QtWidgets.QPushButton(self.tab_video)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.inout_controls.addWidget(self.btn_run)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_openin.setText(_translate("MainWindow", "..."))
        self.lbl_output.setText(_translate("MainWindow", "Output Folder"))
        self.btn_chooseout.setText(_translate("MainWindow", "..."))
