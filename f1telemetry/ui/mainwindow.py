...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolSmoothingButton = QtWidgets.QPushButton(self.dataTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.toolSmoothingButton.sizePolicy().hasHeightForWidth())
        self.toolSmoothingButton.setSizePolicy(sizePolicy)
        self.toolSmoothingButton.setMinimumSize(QtCore.QSize(50, 50))
        self.toolSmoothingButton.setMaximumSize(QtCore.QSize(60, 60))
        self.toolSmoothingButton.setSizeIncrement(QtCore.QSize(0, 0))
        self.toolSmoothingButton.setObjectName("toolSmoothingButton")
        self.toolbar.addWidget(self.toolSmoothingButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolSmoothingButton.setText(_translate("MainWindow", "Smooth"))
